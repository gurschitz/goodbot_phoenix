defmodule Goodbot.Templates do
  @moduledoc """
  In this module, a couple of methods are defined 
  to build the template objects that we need for the Facebook Send API
  """
  
  @doc """
  This method builds a basic attachment map
  """
  def build(:attachment, attachment = %{type: _, payload: _}), do: %{attachment: attachment}

  @doc """
  With this method, we can build an attachment of type "template" with a given payload.
  """
  ...
  @doc """
  With this method, we can build the template for a "generic" template using the given elements.
  """
  ...
  @doc """
  This methods helps to build a generic element that will be used for the generic template.
  """
  ...
  @doc """
  This methods helps to build a button of the type "web_url".
  """
